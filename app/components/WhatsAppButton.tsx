...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 px-5 py-3.5 bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full shadow-2xl font-bold text-sm transition-all duration-300 hover:scale-105 animate-fade-in"
      style={{ boxShadow: '0 8px 32px rgba(37,211,102,0.5)' }}
